...
(_a = document.getElementById('homepageGenerate')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                data = _a.sent();
                if (data.imageUrl) {
                    outfitElement = document.getElementById('homepageOutfitPreview');
                    if (outfitElement) {
